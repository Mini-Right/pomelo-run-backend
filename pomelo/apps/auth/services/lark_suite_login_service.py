...
from pomelo.databases.pomelo_system_user_table import PomeloSystemUserTable, gen_id
...
class PomeloLarkSuiteLoginService(PomeloAuthService):
    def login(self, code: str):
        ...
        user_id = user_info.user_id if user_info else self.create_user(lark_suite_userinfo=lark_suite_userinfo)
