...
from pomelo.handler import (orm_fields_all_to_list, orm_fields_one_to_dict, orm_table_all_to_list, orm_table_one_to_dict)
from pomelo.plugins.session import MySQLSession

__all__ = ['PomeloTableCURD']
...
class PomeloTableCURD(PomeloTableCreate, PomeloTableUpdate, PomeloTableRead, PomeloTableDelete):
    def __init__(self, session=MySQLSession.pomelo):
        super().__init__(session)
